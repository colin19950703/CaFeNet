...
def resolve_data_config(
    ...
    # resolve data + model mean for normalization
    ...
    # resolve data + model std deviation for normalization
    ...
    if verbose:
        _logger.info('Data processing configuration for current model + data:')
